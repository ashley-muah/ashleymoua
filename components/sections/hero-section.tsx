...
import { FileText, Linkedin as LinkedinIcon, BookOpen } from "lucide-react";
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
              <Button asChild variant="outline" size="sm" className="gap-2">
                <a href="/Ash Moua Feb. PM Resume.pdf" target="_blank" rel="noopener noreferrer">
              ...
              <Button asChild variant="outline" size="sm" className="gap-2">
                <a
                  href="https://waopportunityscholarship.org/get-involved/news/ashleys-journey-from-uncertainity-to-opportunity/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
